...
- **Package version** (`pyproject.toml` `[project]`): **1.0.0**
- **Built app tuple** (`version.py` when present): **(1, 2, 0, 51)** — build **51**
- **Git branch**: **dev**
- **Build date** (`version.py`): **2026-04-07**
- **Git revision** (`version.py`): **b63bf4e**
