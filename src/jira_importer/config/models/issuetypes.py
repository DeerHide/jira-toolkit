...
class IssueType:
    ...
    @staticmethod
    def default_level_for_name(name: str) -> int:
        """Return the default hierarchy level for a common issue type name."""
        ...
        if isinstance(old_issue_types, list):
            ...
            for name in old_issue_types:
                if isinstance(name, str) and name.strip():
                    ...
                    level = IssueType.default_level_for_name(name.strip())
